...
const ReceptionistProfile: React.FC = () => {
  ...
  const [profileImage, setProfileImage] = useState<string>("https://api.dicebear.com/7.x/avataaars/svg?seed=Sarah");
  ...
  const [profile, setProfile] = useState({
    ...
    address: "789 Campus Ave, Apt 4B, Campus City, ST 12345",
    dateOfBirth: "1992-08-15",
    role: "Front Desk Officer",
    department: "Administration",
    employeeId: "REC-2021-042",
    joinDate: "2021-03-10",
    languages: "English, Spanish, French",
    shift: "Morning (8:00 AM - 4:00 PM)",
    status: "Active",
    yearsOfExperience: "5",
    qualifications: ["Bachelor of Arts in Communication", "Certified Administrative Professional (CAP)"],
    certifications: [
      { name: "Certified Administrative Professional", issuer: "IAAP", date: "2021-05-20", expiry: "2024-05-20" },
      { name: "Customer Service Excellence", issuer: "Service Institute", date: "2022-01-15", expiry: "N/A" },
      { name: "First Aid & CPR", issuer: "Red Cross", date: "2023-08-10", expiry: "2025-08-10" },
    ],
    bio: "Friendly and organized professional with a passion for helping people. I ensure that every visitor to the university feels welcomed and supported. Expert in schedule management and multi-line phone systems.",
  });

  const handleSave = () => {
    setIsEditing(false);
    toast.success("Receptionist profile synchronized successfully!");
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-200/50 p-3 xs:p-4 sm:p-6 lg:p-8 font-primary">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm sm:text-base text-gray-500">
          Configure identity parameters, credentials, and front-desk security
        </p>
      </div>
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-6 sm:p-10 min-h-[500px]">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
              <div>
                ...
                <p className="text-sm text-gray-400 font-medium mt-1">Configure your desk officer profile information</p>
              </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  <div className="space-y-2">
                    ...
                    <div className="px-5 py-3.5 rounded-2xl bg-gray-50 border border-gray-100 text-gray-500 font-bold flex items-center justify-between">
                       {profile.employeeId}
                       <IoKeyOutline className="text-gray-300" />
                    </div>
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Operational Shift</label>
                    <input
                      type="text"
                      value={profile.shift}
                    ...
                    <div key={idx} className="p-8 rounded-[2rem] border border-gray-100 hover:border-primary-100/30 hover:shadow-2xl hover:shadow-primary-50/10 transition-all duration-500 bg-gradient-to-br from-white to-gray-50/30 group">
                      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-6 mb-6">
                        ...
                        <div className={`px-4 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest border-2 ${
                            cert.expiry === "N/A" || new Date(cert.expiry) > new Date() 
                            ? "bg-green-50 text-green-600 border-green-200" 
                            : "bg-red-50 text-red-600 border-red-200"
                        }`}>
                          {cert.expiry === "N/A" || new Date(cert.expiry) > new Date() ? "Active" : "Expired"}
                        </div>
                      </div>
                      <div className="grid grid-cols-2 gap-8 mt-6 pt-8 border-t border-gray-100">
                        ...
                        <div className="space-y-1 text-right sm:text-left">
                          ...
                          <div className="text-sm font-bold text-gray-700 flex items-center gap-2 justify-end sm:justify-start">
                            <IoCalendarOutline className="w-4 h-4 text-primary-100" />
                            {cert.expiry === "N/A" ? "Permanent" : new Date(cert.expiry).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            {activeTab === "settings" && (
              <div className="space-y-12 animate-fadeIn max-w-2xl">
                ...
                <div className="pt-12 text-center">
                   ...
                   <p className="text-[10px] text-gray-400 mt-4 font-black uppercase tracking-widest">Protocol Version 4.8.2-REC</p>
                </div>
              </div>
            )}
          </div>
