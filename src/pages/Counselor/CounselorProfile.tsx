...
const CounselorProfile: React.FC = () => {
    ...
    const [profile, setProfile] = useState({
        ...
        email: "counselor@sanverse.com",
        phone: "+1 (555) 987-6543",
        location: "Counseling Center, Room 205",
        bio: "Dedicated school counselor with over 8 years of experience in academic counseling, career guidance, and student mental health support. Passionate about helping students navigate their educational journey and achieve their full potential. Specialized in adolescent psychology and college admissions counseling.",
        certifications: [
        ...
        specializations: ["Academic Counseling", "Career Guidance", "Mental Health Support", "College Admissions"],
        experience: "8 Years"
    });
    ...
    return (
        <div className="min-h-screen bg-gray-50/50 p-4 sm:p-6 lg:p-8">
            <div className="max-w-5xl mx-auto">
                {/* Header / Cover */}
                <div className="relative h-48 rounded-3xl bg-gradient-to-r from-primary-100 to-primary-50 shadow-lg overflow-hidden mb-16">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                            <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
                                <IoSchoolOutline className="text-primary-100" /> Specializations
                            </h3>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                            <h3 className="text-lg font-bold text-gray-900 mb-4">Professional Attributes</h3>
                            <div className="grid sm:grid-cols-2 gap-4">
                                ...
                                <div className="p-4 bg-green-50/50 rounded-xl border border-green-100">
                                    <p className="text-xs font-bold text-green-600 uppercase mb-1">Active Cases</p>
                                    <p className="text-xl font-bold text-gray-900">18 Students</p>
                                </div>
                                <div className="p-4 bg-purple-50/50 rounded-xl border border-purple-100">
                                    <p className="text-xs font-bold text-purple-600 uppercase mb-1">Success Rate</p>
                                    <p className="text-xl font-bold text-gray-900">92%</p>
                                </div>
                                <div className="p-4 bg-amber-50/50 rounded-xl border border-amber-100">
                                    <p className="text-xs font-bold text-amber-600 uppercase mb-1">Sessions/Week</p>
                                    <p className="text-xl font-bold text-gray-900">25-30</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-2xl p-6 border border-green-100">
                            <div className="flex items-center gap-2 mb-3">
                                ...
                                <h3 className="font-bold text-gray-900">Counseling Philosophy</h3>
                            </div>
                            <p className="text-sm text-gray-600 leading-relaxed">
                                "Every student has unique strengths and potential. My role is to help them discover their path, overcome challenges, and build the confidence to achieve their dreams."
                            </p>
                        </div>
                    </div>
                </div>
