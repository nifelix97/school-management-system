...
const links = [
  ...
  {
    to: "/transport-manager/fees",
    label: "Transport Fees",
    icon: <IoCashOutline className="w-5 h-5" />,
  },
  {
    to: "/transport-manager/maintenance",
    label: "Maintenance",
  ...
  },
  {
    ...
    label: "Vehicle Fleet",
    icon: <IoBusOutline className="w-5 h-5" />,
  },
  {
...
const TransportManagerSidebar = ({ className = "" }: SidebarProps) => {
  ...
  return (
    <>
      ...
      {!isDesktop && (
        <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-primary-50 backdrop-blur-md shadow">
          <div className="flex items-center justify-between px-4 py-3">
            ...
            <div className="font-heading text-white text-xl">Transport Portal</div>
            <span className="w-6" />
          </div>
        </div>
      )}
      ...
      <aside
        ...
        aria-label="Transport Manager sidebar"
      >
...
export default TransportManagerSidebar;
