...
type Props = {
  ...
  onUpdatePersonal?: (data: TeacherProfileUpdate) => Promise<void> | void;
};
...
//     <div className="flex items-center gap-2 text-base sm:text-lg text-primary-50 font-semibold">
//       <span className="w-2.5 h-2.5 rounded-full bg-primary-100" />
//       Emergency contact
//     </div>

//     <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 md:gap-6 mt-3 sm:mt-4">
//       <div>
...
//         className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base rounded-full border border-primary-100 text-primary-100 bg-white hover:bg-primary-100/10"
//       >
...
//         className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base rounded-full border border-red-200 text-red-600 bg-white hover:bg-red-50"
//       >
      ...
      {active === "Professional details" && (
        <div className="mt-4 sm:mt-5 md:mt-6 lg:mt-8 bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-100 p-3 sm:p-4 md:p-6 lg:p-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 md:gap-6">
            ...
            <Field label="Office Hours" value={profile.officeHours} />
            <Field label="Office Location" value={profile.officeLocation} />
          </div>
          <div className="mt-4">
      ...
      {/* {active === "Emergency contacts" && (
        <div className="mt-4 sm:mt-5 md:mt-6 lg:mt-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
            <h3 className="m-0 text-lg sm:text-xl md:text-2xl text-primary-50 font-semibold">
              Emergency contacts
            </h3>
            <button
              type="button"
              onClick={onCreateEmergencyContact}
              className="inline-flex items-center gap-2 px-4 sm:px-5 py-2.5 sm:py-3 text-sm sm:text-base rounded-full bg-primary-100 text-primary-50 hover:opacity-90 self-start sm:self-auto"
            >
